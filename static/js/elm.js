...
var _user$project$FloorPlanTypes$FloorPlan = F8(
	function (a, b, c, d, e, f, g, h) {
		return {id: a, aspect_ratio: b, image: c, is_public: d, is_trashed: e, name: f, owner: g, last_updated: h};
	});
var _user$project$FloorPlanTypes$Location = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
...
var _user$project$Main$locationInfoList = function (locations) {
	return A2(
		_elm_lang$core$List$map,
		function (location) {
			return A2(
...
var _user$project$Main$isTypeSelected = F2(
	function (typeSelected, t) {
		return _elm_lang$core$Native_Utils.eq(typeSelected, t);
	});
var _user$project$Main$px = function (i) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
					...
					_0: _elm_lang$html$Html_Attributes$style(
						{
							...
							_0: A2(
								...
								'top',
								_user$project$Main$px(_p2.y + 10)),
							_1: {
								ctor: '::',
								_0: A2(
									_user$project$Main_ops['=>'],
							...
							_0: A2(
								...
								{ctor: '[]'},
								{
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html$text(
											_elm_lang$core$Basics$toString(_p1.extension)),
										_1: {ctor: '[]'}
									}
								}),
							_1: {
...
var _user$project$Main$getFloorplanDimensions = F2(
	function (size, floorplan) {
		var width = 0.7 * _elm_lang$core$Basics$toFloat(size.width);
		return {width: width, height: width * floorplan.aspect_ratio};
	});
		...
		_0: A2(
			_elm_lang$html$Html$option,
			{
				...
				_0: _elm_lang$html$Html_Attributes$selected(
					A2(_user$project$Main$isTypeSelected, typeSelected, _user$project$Main$defaultSelect)),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text(_user$project$Main$defaultSelect),
				_1: {ctor: '[]'}
			}),
		_1: {ctor: '[]'}
	};
			...
			function (opt) {
				return A2(
					_elm_lang$html$Html$option,
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$selected(
							A2(_user$project$Main$isTypeSelected, typeSelected, opt)),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
					...
					return function (f) {
						return function (g) {
							return function (h) {
								return function (i) {
									return function (j) {
										return {floorplan: a, locations: b, nameInput: c, typeSelect: d, toolTip: e, filteredLocations: f, filters: g, floorplanDimensions: h, token: i, user: j};
									};
								};
							};
						};
...
var _user$project$Main$Showing = F2(
	function (a, b) {
		return {ctor: 'Showing', _0: a, _1: b};
	});
			...
			case 'NameInputChange':
				...
				return A3(
					...
					A2(
						...
						_user$project$Main$filterByName(_p6)),
					_elm_lang$core$Native_Utils.update(
						model,
						{nameInput: _p6}));
			case 'TypeSelectChange':
				var _p7 = _p4._0;
				var filterMsg = _elm_lang$core$Native_Utils.eq(_p7, _user$project$Main$defaultSelect) ? _user$project$Main$Remove : _user$project$Main$Merge;
				return A3(
					_user$project$Main$updateFilter,
					filterMsg,
					A2(
						...
						_user$project$Main$filterByType(_p7)),
					_elm_lang$core$Native_Utils.update(
						model,
						{typeSelect: _p7}));
				...
				if (_p8.ctor === 'Nothing') {
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								toolTip: A2(_user$project$Main$Showing, _p9, _elm_lang$core$Maybe$Nothing)
							}),
						{ctor: '[]'});
				} else {
					return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							floorplanDimensions: _elm_lang$core$Maybe$Just(
								A2(_user$project$Main$getFloorplanDimensions, _p4._0, model.floorplan))
						}),
					{ctor: '[]'});
		}
	});
...
var _user$project$Main$init = function (flags) {
	return A2(
		_elm_lang$core$Platform_Cmd_ops['!'],
		{
			floorplan: _user$project$FloorPlanTypes$newFloorPlan(flags.floorplan),
...
var _user$project$Main$ShowToolTip = F2(
	function (a, b) {
		return {ctor: 'ShowToolTip', _0: a, _1: b};
	});
var _user$project$Main$plotLocations = F2(
	function (dimensions, locations) {
		return A2(
			_elm_lang$core$List$map,
			function (location) {
				return A2(
...
var _user$project$Main$svgMap = F3(
	function (floorplan, dimensions, locations) {
		var _p10 = dimensions;
			...
			return A2(
				...
				},
				{
					...
					_0: A2(
											...
											_0: A2(
												...
												A2(
													...
													A2(
														_elm_lang$core$Basics_ops['++'],
														'http://localhost:8000',
														A2(_elm_lang$core$Basics_ops['++'], floorplan.image, ')')))),
											_1: {
												ctor: '::',
						...
						A2(_user$project$Main$plotLocations, _p11, locations)),
					_1: {ctor: '[]'}
				});
		}
	});
var _user$project$Main$subscriptions = function (model) {
	var _p12 = model.toolTip;
	if ((_p12.ctor === 'Showing') && (_p12._1.ctor === 'Nothing')) {
		return _elm_lang$core$Platform_Sub$batch(
			{
				...
				_0: _elm_lang$mouse$Mouse$moves(
					function (x) {
						return A2(
							_user$project$Main$ShowToolTip,
							_p12._0,
...
var _user$project$Main$NameInputChange = function (a) {
	return {ctor: 'NameInputChange', _0: a};
};
var _user$project$Main$filterForm = F2(
				...
				_1: {
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$ResetFilterForm),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
...
var _user$project$Main$viewFilterLocations = function (_p13) {
	var _p14 = _p13;
	return A2(
		_elm_lang$html$Html$div,
		{
		...
		},
		{
			...
			_1: {
				ctor: '::',
				_0: A2(_user$project$Main$filterForm, _p14.nameInput, _p14.typeSelect),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$div,
						...
						_user$project$Main$locationInfoList(_p14.filteredLocations)),
					_1: {ctor: '[]'}
				}
			}
		});
			...
			_1: {
				...
				_0: A2(
					...
					},
					{
						...
						_1: {
							ctor: '::',
							_0: A3(_user$project$Main$svgMap, model.floorplan, model.floorplanDimensions, model.filteredLocations),
							_1: {ctor: '[]'}
						}
					}),
				_1: {
																	...
																	return A2(
																		...
																		function (name) {
																			return A2(
																				...
																				function (owner) {
																					return _elm_lang$core$Json_Decode$succeed(
																						{aspect_ratio: aspect_ratio, id: id, image: image, is_public: is_public, is_trashed: is_trashed, last_updated: last_updated, locations: locations, name: name, owner: owner});
																				},
																				...
																				return A2(
																					...
																					function (extension) {
																						return A2(
																																		...
																																		return A2(
																																			...
																																			function (position_x) {
																																				return A2(
																																					...
																																					function (position_y) {
																																						return _elm_lang$core$Json_Decode$succeed(
																																							{details: details, extension: extension, floorplan: floorplan, id: id, is_trashed: is_trashed, last_updated: last_updated, loc_type: loc_type, name: name, position_x: position_x, position_y: position_y});
																																					},
																																					A2(_elm_lang$core$Json_Decode$field, 'position_y', _elm_lang$core$Json_Decode$float));
																																			},
																																			A2(_elm_lang$core$Json_Decode$field, 'position_x', _elm_lang$core$Json_Decode$float));
																																	},
																																	A2(_elm_lang$core$Json_Decode$field, 'name', _elm_lang$core$Json_Decode$string));
																															},
																															A2(_elm_lang$core$Json_Decode$field, 'loc_type', _elm_lang$core$Json_Decode$string));
																													},
																							...
																							A2(_elm_lang$core$Json_Decode$field, 'floorplan', _elm_lang$core$Json_Decode$int));
																					},
																					A2(
																						_elm_lang$core$Json_Decode$field,
																						'extension',
